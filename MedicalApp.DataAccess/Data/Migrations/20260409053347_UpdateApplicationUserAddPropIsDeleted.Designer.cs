...
namespace MedicalApp.DataAccess.Data.Migrations
{
    ...
    [Migration("20260409053347_UpdateApplicationUserAddPropIsDeleted")]
    partial class UpdateApplicationUserAddPropIsDeleted
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MedicalApp.DataAccess.Data.Models.Patient", b =>
                {
                    b.HasOne("MedicalApp.DataAccess.Data.DBContexts.ApplicationUser", "ApplicationUser")
                        .WithOne("Patient")
                        .HasForeignKey("MedicalApp.DataAccess.Data.Models.Patient", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
